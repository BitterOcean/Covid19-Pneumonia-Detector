  ...
  return (
    <React.Fragment>
      ...
      <AlertDialogSlide
        ...
        cardContentBody2={`- PNEUMONIA : ${alertOpen ? localStorage.getItem('pneumonia-probability').slice(0, 10) : ''}%`}
        cardContentBody3={`- NORMAL    : ${alertOpen ? localStorage.getItem('normal-probability').slice(0, 10) : ''}%`}
      />
      <Footer />
    </React.Fragment>
  );
